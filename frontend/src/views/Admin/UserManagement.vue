  ...
  <div class="user-management">
    <div class="header-container">
      ...
      <Transition name="fade">
        <p v-if="statusMessage" class="status-banner" :class="{ success: isSuccess, error: !isSuccess }" :role="isSuccess ? 'status' : 'alert'" aria-live="polite">{{ statusMessage }}</p>
      </Transition>
    </div>
...
const deleteUser = async (user) => {
  if (confirm(`Delete user "${user.username}"?`)) {
    ...
    try {
      ...
      showStatus(`User "${user.username}" deleted successfully!`);
      fetchUsers();
    } catch (err) {
