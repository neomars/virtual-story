  ...
  <div class="user-management">
    <div class="header-container">
      ...
      <Transition name="fade">
        <div v-if="statusMessage" class="status-msg" :class="{ 'status-success': isSuccess, 'status-error': !isSuccess }" role="status">
          {{ statusMessage }}
        </div>
      </Transition>
    </div>
    ...
    <section class="admin-section">
      ...
      <form @submit.prevent="changePassword" class="settings-form">
        <div class="form-group">
          ...
          <input type="password" id="old-password" v-model="passChange.oldPassword" required aria-required="true" autocomplete="current-password" />
        </div>
        <div class="form-group">
          <label for="new-password">New password</label>
          <input type="password" id="new-password" v-model="passChange.newPassword" required aria-required="true" autocomplete="new-password" />
        </div>
    ...
    <section class="admin-section">
      ...
      <form @submit.prevent="createUser" class="add-user-form">
        ...
        <input type="password" id="new-password-field" v-model="newUser.password" placeholder="Password" required aria-required="true" autocomplete="new-password" />
