...
<template>
  <div>
      ...
      <div class="side-panel">
        ...
        <ul class="relation-list">
          <li v-for="parent in relations.parent_scenes" :key="parent.id" class="relation-item">
            ...
            <button @click="removeParentLink(parent.choice_id)" class="button-delete" :aria-label="'Remove link from ' + parent.title"><span aria-hidden="true">&times;</span></button>
          </li>
    ...
    <router-link to="/admin/scenes" class="back-link" v-if="isEditing"><span aria-hidden="true">&larr;</span> Back to list</router-link>
  </div>
</template>
