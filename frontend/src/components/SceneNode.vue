  ...
  <div class="scene-node">
    <div class="scene-info">
      <button
        ...
        :aria-label="isExpanded ? 'Collapse branch: ' + scene.title : 'Expand branch: ' + scene.title"
    ...
    <div v-if="isExpanded && scene.children && scene.children.length > 0" class="children-container">
