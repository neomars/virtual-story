  ...
  <div class="scene-node">
    <div class="scene-info">
      <button
        ...
        :aria-label="isExpanded ? 'Collapse children of ' + scene.title : 'Expand children of ' + scene.title"
      >
    ...
    <div v-if="scene.children && scene.children.length > 0 && isExpanded" class="children-container">
...
const deleteScene = async () => {
  if (confirm(`Are you sure you want to delete the scene "${props.scene.title}"?\nThis action is permanent and will also delete all incoming choices leading to this scene, which might break the narrative flow.`)) {
