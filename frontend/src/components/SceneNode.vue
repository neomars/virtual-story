  ...
  <div class="scene-node">
    <div class="scene-info">
      <button
        ...
        :aria-label="(isExpanded ? 'Collapse' : 'Expand') + ' children of ' + scene.title"
      >
    ...
    <div v-if="scene.children && scene.children.length > 0" v-show="isExpanded" :id="'children-' + scene.id" class="children-container">
